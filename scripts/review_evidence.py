...
HIVE_REL_003_FORBIDDEN_PREFIXES = HIVE_REL_002_FORBIDDEN_PREFIXES
...
def require_hive_rel_003_scope(
    ...
    *,
    ...
    """Bound the publisher correction to the workflow, request and its governance bridge."""
    ...
    if unauthorized:
        raise ValueError(
            f"{HIVE_REL_003_WORK_ORDER} changes paths outside the bounded publisher correction: "
            + ", ".join(unauthorized)
        )
    forbidden = sorted(
