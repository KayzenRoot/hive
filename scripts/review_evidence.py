...
WO025_G3_BASE_SHA = "7e52a5231b4bfadc54b3591f1ce3e3f22e40e66b"
...
# a grant.
#
# Every entry below other than the three WO-025 registrations was accepted by the previous
...
def verify_wo025_g1_governance_contract(
    ...
    return (
        ...
        "wo025_planning_only_registered=True; unknown_WO-026=REJECTED; "
        f"active_promotions={WO024_G1_WORK_ORDER},{WO024P_WORK_ORDER}; "
...
def verify_wo025_g3_governance_contract(
    ...
    for rejected in ("WO-1.1-02", "WO-11-01", "WO-12-99", "WO-22-01", "WO-026", "WO-026-P", ""):
        try:
