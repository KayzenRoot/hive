...
- Zero unresolved CRITICAL/HIGH findings at the release candidate head; project
  isolation, provenance and fail-closed security behavior are covered by the
...
accepted product closure evidence remains DoD 46/46 PASS, 0 FAIL, 0 UNKNOWN,
HIGH/CRITICAL 0/0.
