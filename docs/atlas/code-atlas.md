...
- backend/app/executor_cli.py: Python source or test module.
...
- backend/tests/test_executor_cli.py: Python source or test module.
...
- backend/tests/test_release_publisher_contract.py: Python source or test module.
...
- backend/tests/test_verify_release_metadata.py: Python source or test module.
...
- dashboard/src/vite-env.d.ts: TypeScript/React source or test module.

## Migrations

- migrations/__init__.py: Ordered PostgreSQL business-schema revision.
- migrations/env.py: Ordered PostgreSQL business-schema revision.
...
- scripts/release_publisher_contract.py: deterministic maintenance or validation script.
...
- scripts/verify_release_metadata.py: deterministic maintenance or validation script.
