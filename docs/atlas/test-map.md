...
| backend/tests/test_registry.py | Path boundary, Git inspection, language detection and states. |
...
| scripts/project_registry_integration.py | Clean-database real-Git registry E2E and persistence smoke. |
